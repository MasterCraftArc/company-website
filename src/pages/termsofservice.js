      ...
      >
        ...
        <main className="termsOfService">
          <p>
            ...
            (collectively, "Website"), as owned and operated by Defense
            Unicorns.
          </p>
          ...
          <p>
            ...
            between you and Defense Unicorns, and supersede all other
          ...
          <p>
            The last update to our Terms of Service was posted on February 22,
            2022.
          </p>
          ...
          <ul>
            <li>
              The terms "us" or "we" or "our" refers to Defense Unicorns, the
          ...
          <ol className="list-decimal list-inside">
            <li>
              ...
              materials (information or software) on Defense Unicorns’s Website
              ...
              <ol className="list-decimal list-inside ml-3 my-2">
                ...
                <li>
                  ...
                  contained on Defense Unicorns’s website;
                </li>
                <li>
            ...
            <li>
              ...
              these restrictions and may be terminated by Defense Unicorns at
          ...
          <p>
            ...
            images, text, page layout, or type) of Defense Unicorns without
            express composed consent. You might not use any meta tags or any
            various other "unseen text" utilizing Defense Unicorn's name or
            trademarks without the express written consent of Defense Unicorns.
            You agree not to offer or modify any content found on the Website
            consisting of, however not limited to, names of Users and Content,
            or to recreate, display, openly perform, distribute, or otherwise
            make use of the Material, in any way for any public function, in
            connection with services or products that are not those of Defense
            Unicorns, in other way that is likely to trigger confusion among
            consumers, that disparages or challenges Defense Unicorns or its
            licensors, that dilutes the strength of Defense Unicorns' or its
            licensor's residential property, or that otherwise infringes Defense
            Unicorns' or its licensor's copyright rights. You also agree to
            abstain from abusing any of the material that appears on the Site.
            The use of the Material on any other website or in a networked
            computer system environment for any purpose is prohibited. Any code
            that Defense Unicorns develops to generate or show any Material of
            the pages making up the Website is likewise secured by Defense
            Unicorns's copyright, and you may not copy or adjust such code.
          </p>

          <p>
            Defense Unicorns has no duty to keep track of any products
            published, transferred, or connected to or with the Site. If you
            think that something on the Website breaches these Terms please
            contact our marked representative as set forth below.
          </p>

          <p>
            If alerted by a User of any products which allegedly do not conform
            to these Terms, Defense Unicorns could in its single discernment
            explore the allegation and figure out whether to take other actions
            or ask for the removal or get rid of the Content. Defense Unicorns
            has no liability or duty to Individuals for efficiency or
          ...
          <p>
            ...
            our Website. Defense Unicorns reserves the right to investigate
          ...
          <p>
            ...
            technical, typographical, or photographic errors. Defense Unicorns
            does not warrant that any of the materials on its Website are
            accurate, complete, or current. Defense Unicorns may make changes to
            the materials contained on its Website at any time without notice.
            Defense Unicorns does not, however, make any commitment to update
            the materials.
          </p>
          ...
          <p>
            ...
            <span className="font-bold">Defense Unicorns</span> makes no
            ...
            other violation of rights. Furthermore,{" "}
            <span className="font-bold">Defense Unicorns</span> does not warrant
            ...
            this site. The Website serves as a venue for Individuals to purchase
            distinct service or products. Neither Defense Unicorns nor the
            Website has control over the quality or fitness for a particular
            function of a product. Defense Unicorns likewise has no control over
            the accuracy, reliability, completeness, or timeliness of the
            User-submitted details and makes no representations or warranties
          ...
          <p>
            ...
            AVAILABLE TO YOU THROUGH THIS WEBSITE ARE PROVIDED BY Defense
            Unicorns ON AN "AS IS" AND "AS AVAILABLE" BASIS, UNLESS OTHERWISE
            SPECIFIED IN WRITING. Defense Unicorns MAKES NO REPRESENTATIONS OR
            WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, ABOUT THE OPERATION OF
            THIS WEBSITE OR THE INFO, MATERIALS, PRODUCTS (INCLUDING SOFTWARE)
            OR SERVICES LISTED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH
            THIS SITE, UNLESS OTHERWISE POINTED OUT IN WRITING. YOU EXPRESSLY
            AGREE THAT YOUR USE OF THIS WEBSITE IS AT YOUR OWN RISK.
          </p>

          <p>
            TO THE COMPLETE EXTENT PERMISSIBLE BY APPLICABLE LAW, Defense
            Unicorns DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING,
            BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY AND
            PHYSICAL FITNESS FOR A PARTICULAR PURPOSE. Defense Unicorns DOES NOT
            WARRANT THAT THIS WEBSITE; DETAILS, CONTENT, MATERIALS, PRODUCTS
            (INCLUDING SOFTWARE APPLICATION) OR SERVICES CONSISTED OF ON OR
            OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SITE; ITS SERVERS; OR
            EMAIL SENT FROM Defense Unicorns ARE WITHOUT VIRUSES OR OTHER
            HARMFUL ELEMENTS. Defense Unicorns WILL NOT BE LIABLE FOR ANY
            DAMAGES OF ANY KIND ARISING FROM THE USE OF THE WEBSITE OR FROM ANY
            DETAILS, CONTENT, MATERIALS, PRODUCTS (INCLUDING SOFTWARE
            APPLICATION) OR SERVICES LISTED ON OR OTHERWISE MADE AVAILABLE TO
            YOU WITH THIS SITE, INCLUDING, BUT NOT LIMITED TO DIRECT, INDIRECT,
            INCIDENTAL, PUNITIVE, AND CONSEQUENTIAL DAMAGES, UNLESS OTHERWISE
            POINTED OUT IN WRITING. UNDER NO SCENARIO SHALL Defense Unicorns'S
            LIABILITY DEVELOPING FROM OR IN CONNECTION WITH THE WEBSITE OR YOUR
            USE OF THE WEBSITE, DESPITE THE REASON FOR ACTION (WHETHER IN
            AGREEMENT, TORT, BREACH OF SERVICE WARRANTY OR OTHERWISE)
          </p>
          ...
          <p>
            ...
            recommendation of such third party websites. Defense Unicorns has no
          ...
          <p>
            Defense Unicorns may revise these Terms of Service for its Website
          ...
          <p>
            Any claim relating to Defense Unicorns’s Website shall be governed
            by the laws of Colorado without regard to its conflict of law
            provisions, and You consent to exclusive jurisdiction and venue in
            such courts.
          </p>
          ...
          <p>
            You accept defend, indemnify, and hold safe Defense Unicorns, its
            ...
            (iii) Your breach of the terms of these Terms. Defense Unicorns will
          ...
          <p>
            Our Legal Terms shall be treated as though they were executed and
            performed in Colorado and shall be governed by and construed in
            accordance with the laws of Colorado without regard to conflict of
            law principles. In addition, you agree to submit to the personal
            ...
            provision. The rights of Defense Unicorns under our Legal Terms
