      ...
      >
        ...
        <main className="privacyPolicy">
          ...
          <ul className="list-disc">
            When you use our Website, we automatically collect certain comuluter information by the interaction of your mobile phone or web browser with our Website. Such information is typically considered Non Personal Information. We also collect the following:
            <li className="ml-4">
