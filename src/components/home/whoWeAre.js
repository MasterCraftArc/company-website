  ...
  return (
    ...
    >
      <div className="xl:w-4/5 mx-auto grid lg:grid-cols-2 grid-cols-1">
        <div className=" p-16 lg:px-5 relative">
          <div className="tk-blob opacity-90">
          ...
          <img
            src={whoWeAre}
            className="blobTop z-10 p-16 lg:p-5"
            alt="unicorn under magnifying glass"
          />
        </div>
        <div className="flex flex-col justify-center px-20 text-white">
          <h2
            className={`text-4xl md:text-5xl xl:text-6xl font-bold flex items-center`}
          >
            <img
