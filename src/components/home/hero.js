...
const HomeHero = () => {
  return (
    <section className="homeHero min-h-screen flex flex-col justify-center">
    <div className="mb-24">
          <h1 className={`${TITLE_TEXT} sm:text-7xl xl:text-8xl 2xl:text-9xl text-white lg:ml-24 md:ml-16 sm:ml-8 ml-4 font-sans`}>
            <p>The World</p> 
            Needs a Hero...
          </h1>
          <motion.h1
